...
### Example using Bauta.js with a @axa-group/bautajs-fastify plugin

#### Creating the Bauta.js instances and setting up the inheritance outside the plugin

```js
const { BautaJS } = require('@axa-group/bautajs-core');
const { bautajsFastify } = require('@axa-group/bautajs-fastify')
...
### Example using Bauta.js with a @axa-group/bautajs-express plugin
