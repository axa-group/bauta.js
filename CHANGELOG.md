...
# [1.4.0](http://github.axa.com/Digital/bauta-nodejs/compare/v1.3.3...v1.4.0) (2019-07-15)


### Features

* **bautajs-express:** add swagger as an url and expose it by /openapi.json path ([750d246](http://github.axa.com/Digital/bauta-nodejs/commit/750d246))
...
* **bautajs:** take components parameter in account on filter schemas ([69038b3](http://github.axa.com/Digital/bauta-nodejs/commit/69038b3)), closes [#80](http://github.axa.com/Digital/bauta-nodejs/issues/80)
* **bautajs:** take components parameter in account on filter schemas ([8d533f9](http://github.axa.com/Digital/bauta-nodejs/commit/8d533f9)), closes [#80](http://github.axa.com/Digital/bauta-nodejs/issues/80)
...
* **bautajs:** update native-proxy-agent and multipart-request-builder to 2.0.0 and remove it from this repo ([047ffa1](http://github.axa.com/Digital/bauta-nodejs/commit/047ffa1))
