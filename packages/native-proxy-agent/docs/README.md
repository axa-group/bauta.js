...
*Defined in [types.ts:48](https://github.axa.com/Digital/bauta-nodejs/blob/9b864df/packages/native-proxy-agent/src/types.ts#L48)*
...
*Defined in [agent.ts:33](https://github.axa.com/Digital/bauta-nodejs/blob/9b864df/packages/native-proxy-agent/src/agent.ts#L33)*
